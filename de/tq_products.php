...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Wir sind Ihr umfassender IT-Partner. Unsere Dienstleistungspalette umfasst alle Services die Sie als KMU benötigen.">
    ...
    <div class="index-container">
        ...
        <div class="under-section">
            ...
            <div class="under-section-col-right">
                <p>TEQLY ist Ihr kompetenter Partner im Web. Je nach Ihren Bedürfnissen bauen wir Ihnen eine klassische HTML-Seite oder setzen ein bewährtes CMS wie Wordpress oder Joomla ein. Wir bieten Ihnen ein "Rundum Sorglos"-Paket für Ihren Webauftritt an und kümmern uns um Entwicklung, Hosting, SEO, Werbung, Unterhalt und E-Mail Verwaltung. <a href="tq_contact.php">Kontakt aufnehmen.</a></p>
            </div>
        </div>
        <div class="under-section">
            <div class="lineblack-index"></div>
