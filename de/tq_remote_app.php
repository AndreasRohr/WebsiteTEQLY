...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Hier können Sie schnell und einfach unseren Remote-Support-Client für Windows und Mac herunterladen.">
...
<div id="main" style="margin-top: 7rem">
    <div class="title-row">
        <div class="title-left">
                <h1 id="titleh1" class="indextitle">Remote Support App.</h1>
        </div>
    </div>
    <div class="index-container">
        <div  class="title-right">
            <h2>Hier können Sie schnell und einfach unseren Remote-Support-Client herunterladen.</h2>
        </div>
        <!-- EASIT.rent Block -->
        ...
        <div class="products-wrapper">
            <div class="products-col-right">
                <p>Für den Remote Support nutzen wir das Programm RustDesk. Nach dem Download können Sie das Programm auf Ihrem Computer Installieren und uns Ihre ID mitteilen. Anschliessend versuchen wir uns zu Verbinden, sobald Sie die Verbindung akzeptieren können wir Ihren Bildschirm sehen und Ihren PC Fernsteuern um Ihr Support-Problem zu lösen. Ohne Ihre Bestätigung können wir nie auf Ihren PC zugreifen.</p>
                <a href="/assets/downloads/V1_1_9/rustdesk-1.1.9-windows_x64.zip">Download für Windows.</a>
                <a href="/assets/downloads/V1_1_9/rustdesk-1.1.9.dmg">Download für MAC.</a>
            </div>
        </div>
