...
<div id="main" style="margin-top: 7rem">
    <div class="title-row">
        <div class="title-left">
            <div class="typewriter">
                <h1 id="titleh1" class="indextitle">Allgemeine<br>Geschäftsbedingungen.</h1>
            </div>
        </div>
    </div>
    <div class="index-container">
        ...
        <h1>I. Allgemeines</h1>
        <h2>A. Inhalt und Geltung</h2>
        <p>Der Vertragsgegenstand ist in Nachträgen zu diesem Vertrag niedergelegt.<br>
            Die allgemeinen Geschäftsbedingungen gelten, wenn die Parteien sie ausdrücklich oder stillschweigend
            anerkennen. Änderungen und Nebenabreden sind nur wirksam, soweit der Lieferant sie schriftlich bestätigt.
        </p>
        <h2>B. Erfüllungsort</h2>
        <p>Soweit kein besonderer Erfüllungsort von den Parteien verabredet ist oder aus der Natur des Geschäftes
            hervorgeht, gilt als Lieferung die Bereitstellung der Produkte am Sitz des Lieferanten.</p>
        <h2>C. Software und Know-how</h2>
        <p>Der Kunde darf die überlassene Software, das Know-how, die Datenträger und Dokumentation im vorgesehenen
        ...
        Know-how-Aufzeichnungen nachträglich ändert.<br>
        ...
        Der Kunde hat auf allen Modifikationen und Kopien die gleichen Schutzrechtsvermerke wie auf dem Original
            anzubringen.</p>
        <h2> D. Dokumentation</h2>
        <p>Der Kunde hat ein Anrecht auf ein Exemplar der Benutzerdokumentation in der üblichen Ausführung des
        Lieferanten. Zusätzliche Exemplare oder Dokumentationen in nicht bereits vorhandenen Sprachen darf der
        Lieferant gesondert in Rechnung stellen.<br>
        Abweichungen in der Dokumentation, namentlich bei Beschreibungen und Abbildungen, sind zulässig, sofern die
            Unterlagen ihre Zwecke erfüllen.</p>
        <h2> E. Diskretion</h2>
        <p>Beide Parteien werden sämtliche Informationen aus dem Geschäftsbereich des andern, die weder allgemein
        ...
        Tätigkeit Kenntnisse weiterverwenden, die sie bei der Geschäftsabwicklung erwirbt.<br>
            Die Parteien überbinden diese Verpflichtung auch ihren Mitarbeitern und Erfüllungsgehilfen.</p><br>
        <h2> F. Informationspflicht des Kunden</h2>
        <p>Der Kunde hat den Lieferanten rechtzeitig auf besondere technische Voraussetzungen sowie auf die
        gesetzlichen, behördlichen und anderen Vorschriften am Bestimmungsort aufmerksam zu machen, soweit sie für
            die Ausführung und den Gebrauch der Produkte von Bedeutung sind.</p>
        <h2> G. Termine</h2>
        <p>Verbindlich sind ausschliesslich schriftlich zugesicherte Termine, wie insbesondere Bereitschaftszeiten
        ausserhalb der üblichen Arbeitszeit, eine bestimmte Reparaturzeit oder eine Reaktionszeit etc. Solche
        Termine verlängern sich angemessen,<br>
        a) wenn dem Lieferanten Angaben, die er für die Ausführung benötigt, nicht rechtzeitig zugehen oder wenn der
        Kunde sie nachträglich ändert;<br>
        b) wenn der Kunde mit den von ihm auszuführenden Arbeiten im Rückstand oder mit der Erfüllung seiner
        vertraglichen Pflichten im Verzug ist, insbesondere wenn er Zahlungsbedingungen nicht einhält;<br>
        ...
        Arbeitskonflikte, verspätete oder fehlerhafte Zulieferungen sowie behördliche Massnahmen.<br>
        Der Lieferant kann Teillieferungen ausführen.<br>
        ...
        drei Tagen erklärt, auf die nachträgliche Leistung verzichten oder vom Vertrag zurücktreten.<br>
        ...
        höchstens zwanzig Prozent des Wertes der verspäteten Lieferung. Weitere Ansprüche aus Verzögerungen sind
            ausgeschlossen.</p>
        <h2> H. Abnahme</h2>
        <p>Sofern kein besonderes Abnahmeverfahren vereinbart ist, hat der Kunde die Produkte selbst zu prüfen und
        allfällige Mängel schriftlich bekannt zu geben. Unterlässt der Kunde die Anzeige innerhalb von vier Wochen
        nach der Lieferung, gelten alle Funktionen als erfüllt und die Lieferung als genehmigt.<br>
        ...
        entdeckt werden können, hat sie der Kunde dem Lieferanten sofort schriftlich anzuzeigen. Andernfalls gilt
            die Lieferung trotz dieser Mängel als genehmigt.</p>
        <h2> I. Garantie</h2>
        <p>Der Lieferant garantiert, dass er die Produkte in funktionstüchtigem Zustand liefert und er die für
        Unterstützungs-, Wartungs- und Serviceleistungen erforderliche Sorgfalt anwendet.<br>
        ...
        oder zum Ersatz der betroffenen Teile.<br>
        ...
        Aufenthaltskosten gehen zu Lasten des Kunden. Ersetzte Teile werden Eigentum des Lieferanten.<br>
        ...
        nicht vom Vertrag zurücktreten oder den Ersatz von Folgeschäden verlangen.<br>
        Die Gewährleistungsfrist beträgt sechs Monate ab Lieferung des Produktes bzw. der Leistung bzw. bei
            Hardware-Wartung sechs Monate ab Vertragsende.</p>
        <h2> J. Weitere Haftung</h2>
        <p>Der Lieferant haftet im Rahmen seiner Haftpflichtversicherung für weiteren Personen- und Sachschaden, der
            dem Kunden nachweisbar durch Verschulden des Lieferanten entsteht. Weitere Ansprüche sind ausgeschlossen.</p>
        <h2> K. Preise und Zahlungsbedingungen</h2>
        <p>Die Preise verstehen sich, soweit nicht anders vermerkt, in Schweizerfranken ohne Mehrwertsteuer, Gebühren,
        ...
        Entschädigungen für wiederkehrende Leistungen sind im Voraus zu bezahlen.<br>
        ...
        Schweizerischen Nationalbank am Tag der Fälligkeit.<br>
            Die Verrechnung von Forderungen durch den Kunden ist ausgeschlossen.</p>
        <h2> L. Besondere Voraussetzungen beim Kunden</h2>
       <p>Der Lieferant kann seine Leistungen nur erbringen, wenn je nach den vereinbarten Leistungen der Kunde die
        notwendigen Massnahmen trifft, insbesondere:<br>
        a) den erforderlichen Platz für die Geräte samt Zubehör sowie die erforderlichen Geräteanschlüsse, wo nötig
        in klimatisierten Räumen, nach den Spezifikationen des Lieferanten zur Verfügung stellt;<br>
        ...
        vertragskonforme Leistung von Bedeutung sind;<br>
        ...
        eines Modems und der notwendigen Kommunikationssoftware;<br>
        g) die allenfalls für die Wartungsarbeiten geeigneten Räume zur Aufbewahrung von Werkzeugen, Material und
        Ersatzteilen zur Verfügung stellt.<br>
        Für Aufwendungen, die durch mangelhafte Voraussetzungen beim Kunden entstehen, darf der Lieferant zusätzlich
           Rechnung stellen.</p>
        <h2> M. Reaktions- und Bereitschaftszeiten</h2>
        <p>Wenn zwischen dem Lieferanten und dem Kunden ausdrücklich eine bestimmte Reaktionszeit vereinbart ist,
        ...
        Antritt der Reise als Arbeitsbeginn.<br>
        Die vertragskonformen Leistungen werden erbracht während den beim Lieferanten üblichen Arbeitszeiten, jedoch
            nicht während Betriebsferien des Lieferanten oder lokalen Feiertagen.</p>
        <h2> N. Dauer des Rechtsverhältnisses</h2>
        <p>Ist nichts Besonderes vereinbart, kann ein Rechtsverhältnis über Hardware-Wartung oder
        Software-Unterstützung jederzeit unter Einhaltung einer dreimonatigen Kündigungsfrist aufgelöst werden.
            Kaufverträge werden mit Erbringung der beidseitigen, vertragskonformen Leistung erfüllt.</p>
        <h2> O. Export</h2>
        <p>Der Kunde ist verantwortlich für die Einhaltung von in- und ausländischen Exportvorschriften. Die
        ...
        einer Bewilligung dieser Amtsstelle gestattet (Rüstungsexport). Der Lieferant bezeichnet die betreffenden
            Produkte ausdrücklich in Offerten und Rechnungen, womit die Auflage auf den Kunden übergeht.</p>
        <h2> P. Weiterverkauf</h2>
        <p>Soweit nicht Parteiabrede oder die Natur des Geschäftes entgegenstehen, darf der Kunde die Produkte
        verändert oder unverändert weiterveräussern.<br>
        ...
        Software-Lizenzen, aus Geheimhaltung sowie aus allfälligen Bewilligungsvorbehalten für die Wiederausfuhr auf
            die jeweiligen Abnehmer übergehen.</p>
        <h1>II. Kaufverträge</h1>
        <h2>A. Umfang, Ausführung und Ort der Lieferung</h2>
        <p>Für Umfang und Ausführung der Lieferung ist die Bestellungsbestätigung massgebend. Der Lieferant liefert die
        ...
        welchen Bedingungen welches Ergebnis angestrebt wird.<br>
        ...
        erfüllen. Der Lieferant ist jedoch nicht verpflichtet, derartige Änderungen auch an Produkten vorzunehmen,
            die bereits hergestellt oder geliefert sind.</p>
                <h1>III. Wartung & Service von Hardware</h1>
        <h2>A. Vollwartung und Depotwartung</h2>
        <p>Bei der Vollwartung erbringt der Lieferant die Wartungsleistungen am Standort der Geräte.
        ...
        Das Risiko des Transportes trägt der Kunde. Die Reparaturzeit beträgt in der Regel fünf Arbeitstage,
            gerechnet zwischen Eintreffen der Geräte beim Lieferanten und dem Versand an den Kunden.</p>
            <h2>B. Umfang der Wartung</h2>
        <p>Für den Umfang und die Ausführung der Wartung ist die Abmachung unter den Parteien massgebend. Ohne
        besondere Abrede sind folgende Wartungsleistungen in den Preisen inbegriffen:<br>
        a) das Beheben von Störungen nach Eingang einer qualifizierten Störungsmeldung, d.h. einer Störungsmeldung,
        aufgrund welcher die Intervention eines Technikers notwendig wird;<br>
        b) der Einbau von Ersatzteilen auf Austauschbasis, ausgetauschte Teile gehen in das Eigentum der
        Wartungsfirma über;<br>
        c) der Einbau von technischen Verbesserungen, soweit diese nach Beurteilung der Wartungsfirma für die
        Funktion der Geräte notwendig sind oder deren Unterhalt erleichtern;<br>
        d) bei der Vollwartung zusätzlich die vorbeugende Wartung mit Präventivkontrollen; der Lieferant teilt dem
        Kunden den dafür notwendigen Zeitaufwand und den Zeitpunkt rechtzeitig mit.<br>
        Für weitere Leistungen ist der Lieferant berechtigt, zusätzlich Rechnung zu stellen, insbesondere wenn:<br>
        a) Störungen oder Schäden zu beheben sind, die durch Eingriffe Dritter oder durch unsachgemässe Behandlung
        sowie durch äussere Einflüsse verursacht wurden;<br>
        b) Störungen zu beheben sind oder bei der Wartung Mehraufwendungen anfallen, weil die Installationen oder
        Standorte (Raumgrössen, Umfeld, Anschlüsse) nicht den Anweisungen des Lieferanten entsprechen;<br>
        ...
        die Dritte verantwortlich sind;<br>
        ...
        hat, das nicht den richtigen Spezifikationen entspricht;<br>
            f) bei der Vollwartung der Standort der Anlage wechselt.</p>
                <h2>C. Eintrittsinspektion</h2>
        <p>Der Lieferant ist berechtigt, eine Eintrittsinspektion durchzuführen, ausgenommen wenn ein Gerät bei
        Lieferung durch den Lieferanten unmittelbar nach Ablauf der Garantiezeit in den Wartungsvertrag aufgenommen
        wird, oder wenn ein Gerät aus einem bestehenden Wartungsvertrag aufgenommen wird.<br>
        Die Eintrittsinspektion umfasst das Beheben von Störungen und den Einbau von technischen Verbesserungen auf
        einen für die einwandfreie Wartung erforderlichen Stand.<br>
        Die Kosten der Eintrittsinspektion gehen zu Lasten des Kunden. Verweigert der Kunde die Eintrittsinspektion,
            fällt die Wartungsverpflichtung dahin.</p>
        <h1>IV. Service & Wartung von Software</h1>
                    <h2>A. Umfang und Ausführung der Unterstützung</h2>
        <p>Für Umfang und Ausführung der Unterstützungsleistung ist die Abmachung unter den Parteien massgebend.
        Dabei bedeuten:<br>
        a) Anwendungsberatung: Beratung über die richtige Anwendung der Software, namentlich über deren
        zweckgerechten Gebrauch und Einsatz.<br>
        b) Kundenschulung: Ausbildung über den richtigen projektspezifischen Gebrauch der Software.<br>
        c) Fehlerbeseitigung: Programmänderungen mit dem Ziel, Fehler oder Schwächen der Software zu beseitigen, die
        einen einwandfreien Betrieb hindern; keine Änderungen über die ursprünglichen Anforderungen hinaus.<br>
        d) Modifikationen: Programmänderungen mit dem Ziel, auch nichtbetriebsbehindernde Fehler oder Schwächen der
        Software zu beseitigen; keine Änderungen über die ursprünglichen Anforderungen hinaus.<br>
        e) Nachlieferung von Modulen: Nachlieferung eines bereits bestehenden, zum bisherigen Software-Paket
        passenden Teiles; ohne zusätzliche Ingenieurleistungen.<br>
        ...
        dazugehörenden Dokumentationen auf den passenden Datenträgern; ohne zusätzliche Ingenieurleistungen.<br>
        h) Erweiterungen: Kundenspezifische Programmänderungen; mit entsprechenden Ingenieurleistungen und über die
        ursprünglichen Anforderungen hinaus.<br>
        i) Integration: Kundenspezifische Einführung neuer, zusätzlicher oder fremder Standard-Software; mit
        entsprechender Ingenieurleistung.<br>
            j) Kundeninformation: Schriftliche Orientierung über Software-Erneuerungen sowie Programmierhinweise.</p>
                        <h2>B. Art der Leistungserbringung</h2>
        <p>Die Unterstützungsleistungen erbringt der Lieferant am Standort des Kunden oder am Standort des zuständigen
        technischen Dienstes des Lieferanten, je nach ihrer Natur, allenfalls nach seiner Wahl,<br>
        a) in den eigenen Räumen;<br>
        b) beim Kunden;<br>
        ...
        <p>Sollten einzelne Vereinbarung gegen geltendes Recht verstossen wird dadurch nicht der gesamte Vertrag
            nichtig. Die nichtigen Klauseln werden durch sinngemässe, konforme Regelungen ersetzt.</p>
                <h1>VI. Gerichtsstand und anwendbares Recht</h1>
        <p>Alle Streitigkeiten aus diesem Vertrag unterstehen materiellem schweizerischem Recht, unter Ausschluss des
            Wiener Kaufrechts. Gerichtsstand ist Muri AG.</p>
        <br><br>
        <p>Version: 2.0<br>
            Stand: 22.02.2022</p>
