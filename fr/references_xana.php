...
<div id="main" style="margin-top: 7rem">
    <div class="title-row">
        <div class="title-left">
                <!--EDIT HERE-->
                <h2 class="references-category">Location de matériel</h2>
                <!--EDIT HERE-->
                <h1  class="indextitle">XANA.care.</h1>
        </div>
    </div>
    <div class="index-container" style="margin-top: 4rem">
        <img alt="Image de produit d'un ordinateur portable de la gamme EASIT.rent." src="../assets/ref_xana.png">
        <div  class="title-right">
            <!--EDIT HERE-->
            <h2>Location de matériel informatique, service inclus<br>12/2021<br>Location flexible de matériel pour une offre de santé mobile.</h2>
        </div>
        ...
        <div class="index-col-left" style="max-width: 20rem;white-space: normal">
            <!--EDIT HERE-->
            <h2>Xana GmbH<br>Bienenweg 10<br>4105 Biel-Benken<br>Basel<br><a href="https://xana.care/">Website</a></h2>
        </div>
        <div class="index-col-right" style="width: 80%">
            <!--EDIT HERE-->
            <p>Xana était à la recherche d'un partenaire matériel pour louer du matériel de manière flexible et a trouvé TEQLY. TEQLY a équipé les centres de santé mobiles de téléphones, de tablettes, d'ordinateurs portables et de routeurs. L'un des défis particuliers de ce projet était l'exigence que tous les appareils disposent d'une connexion Internet directe via le réseau de téléphonie mobile. En collaboration avec nos partenaires de matériel, nous avons pu réaliser ce souhait et configurer des ordinateurs portables spéciaux avec un module 4G.</p>
        </div>
        </div>
    </div>
</div>
