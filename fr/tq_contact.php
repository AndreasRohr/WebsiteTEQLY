...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Nous ne sommes qu'à un mail ou un coup de téléphone de vous. Prenez contact avec nous et nous vous conseillerons volontiers sans engagement.">
...
<div id="main" style="margin-top: 4rem">
    <h1 style="margin-top: 7rem; margin-left: 3rem" class="contact-title">Contact.</h1>
    <div class="contact-row">
        <div class="contact-left" style="margin-left: 2rem;margin-top: 3rem">
            <h2 style="margin-top: 3rem;margin-bottom: 3rem;" class="contact-subtitle">Bureau et magasin:</h2>
        ...
        <div class="contact-mid" style="margin-left: 2rem;margin-top: 3rem">
            <h2 style="margin-top: 3rem;margin-bottom: 3rem;" class="contact-subtitle">Domicile:</h2>
            <h2 style="" class="contact-subtitle">TEQLY GmbH</h2>
    ...
    <div class="three-col" style="margin-bottom: 5rem;margin-left: 2rem">
        <div class="three-col-block">
            <h1>Jannik Frei</h1>
            <p>Direction Développement</p>
            <br>
            <a style="color: black" href="mailto:jannik@teqly.ch?subject=Anfrage%20via%20Webiste&amp;body=Hallo%20Jannik">jannik@teqly.ch</a>
            <br>
            <a style="color: black" href="tel:+41565111131">056 511 11 31</a>
            <br>
            <a style="color: black; font-weight: bolder" href="../assets/vcard_jannik.vcf"
               download="vcard_jannik.vcf">Enregistrer les coordonnées</a>
        </div>
        <div class="three-col-block">
            <h1>Andreas Rohr</h1>
            <p>Direction Support & Infrastructure</p>
            <br>
            <a style="color: black" href="mailto:andreas@teqly.ch?subject=Anfrage%20via%20Webiste&amp;body=Hallo%20Andreas">andreas@teqly.ch</a>
            <br>
            <a style="color: black" href="tel:+41565111132">056 511 11 32</a>
            <br>
            <a style="color: black; font-weight: bolder" href="../assets/vcard_andreas.vcf"
               download="vcard_andreas.vcf">Enregistrer les coordonnées</a>
        </div>
        <div class="three-col-block">
            <h1>Sandro Bütler</h1>
            <p>Direction Consulting & Projets spéciaux</p>
            <br>
            <a style="color: black" href="mailto:sandro@teqly.ch?subject=Anfrage%20via%20Webiste&amp;body=Hallo%20Sandro">sandro@teqly.ch</a>
            <br>
            <a style="color: black" href="tel:+41565111130">056 511 11 30</a>
            <br>
            <a style="color: black; font-weight: bolder" href="../assets/vcard_sandro.vcf"
               download="vcard_sandro.vcf">Enregistrer les coordonnées</a>
        </div>
    </div>
    <div class="three-col" style="margin-bottom: 5rem; margin-left: 2rem">
        <div class="three-col-block">
            <h1>Bureau</h1>
            <br>
            <a style="color: black" href="mailto:info@teqly.ch?subject=Anfrage%20via%20Webiste&amp;body=Guten%20Tag%20Team-TEQLY">info@teqly.ch</a>
            <br>
            <a style="color: black" href="tel:+41565111133">056 511 11 33</a>
            <br>
            <a style="color: black; font-weight: bolder" href="../assets/vcard_bureau.vcf"
               download="vcard_bureau.vcf">Enregistrer les coordonnées</a>
        </div>
        <div class="three-col-block">
            <h1>Support</h1>
            <br>
            ...
            <a style="color: black; font-weight: bolder" href="../assets/vcard_support.vcf"
               download="vcard_support.vcf">Enregistrer les coordonnées</a>
        </div>
    </div>
</div>
</div>
