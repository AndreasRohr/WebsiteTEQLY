...
<div id="main" style="margin-top: 7rem">
    <div class="title-row">
        <div class="title-left">
                <h1 class="indextitle">Nos projets.</h1>
        </div>
    </div>
    <div class="index-container" style="margin-top: 4rem">
        <div  class="title-right">
            <h2>Trouvez l'inspiration.<br><br>Vous trouverez ici une sélection de projets que nous avons eu le plaisir de réaliser avec nos clients par le passé.</h2>
        </div>
        ...
        <div class="index-col-right">
            <p>La boulangerie et confiserie Meier SA à Mägenwil est une entreprise traditionnelle innovante. Les nouvelles technologies ont rendu nécessaire l'extension du réseau interne. C'est ainsi qu'en collaboration avec une entreprise d'électricité locale, l'infrastructure réseau existante a été étendue, permettant ainsi d'accéder à d'autres domaines. <a href="references_meier_2022.php">Apprendre plus.</a></p>
        </div>


        <div class="lineblack-index"></div>
        <h2 class="references-category">Louer du matériel informatique</h2>
        <div class="index-col-left">
...
-->
        ...
        <div class="index-col-right">
            <p>Nous avons conçu et produit des caisses de chargement pour le SCB afin de stocker de manière sûre et efficace les scanners portables utilisés pour le contrôle des billets à l'entrée. Les appareils et un chargeur spécial peuvent être placés dans une caisse UTZ Rako. <a href="references_scb.php">Apprendre plus.</a></p>
        </div>
        ...
        <div class="index-col-right">
            <p>De vastes travaux de transformation et d'extension ont été nécessaires dans la maison centenaire de LeLocle afin de pouvoir exploiter une nouvelle infrastructure réseau. La construction massive du bâtiment a posé des exigences élevées aux composants réseau afin de pouvoir garantir une bonne couverture sans fil. <a href="references_guesthouselelocle.php">Apprendre plus.</a></p>
        </div>

        <div class="lineblack-index"></div>
        <h2 class="references-category">Infrastructure | Projets spéciaux</h2>
        <div class="index-col-left">
            <a href="references_izinsel.php">Inselspital Bern</a>
        </div>
        <div class="index-col-right">
            <p>Pour le nouveau "Centre de vaccination de l'île" de l'hôpital de l'île à Berne, TEQLY a installé une technique de surveillance et de réseau complète ainsi que les logiciels correspondants. La mesure automatisée de la fièvre constitue le cœur du système. <a href="references_izinsel.php">Apprendre plus.</a></p>
        </div>


        <div class="lineblack-index"></div>
        <h2 class="references-category">Développement</h2>
        <div class="index-col-left">
            <a href="references_praxisdz.php">Praxis Dolezal & Zeller</a>
        </div>
        <div class="index-col-right">
            <p>Dolezal & Zeller est un cabinet de psychothérapie et de psychatrie à Olten. Le cabinet nous a engagés pour optimiser les processus dans le domaine de la gestion des patients. Pour ce faire, nous avons fourni un outil qui permet au cabinet de gérer ses patients de manière efficace et claire. <a href="references_praxisdz.php">Apprendre plus.</a></p>
        </div>
        ...
        <div class="index-col-right">
            <p>Afin de pouvoir mettre en place un nouveau système de caisse, le réseau existant a été développé et étendu par la pose de nouveaux câbles réseau. De nouveaux points d'accès et un W-Lan géré complètent le nouveau concept de réseau. <a href="references_kulturhof.php">Apprendre plus.</a></p>
        </div>
        ...
        <div class="index-col-right">
            <p>Dès que l'on voit le site coremio.ch, on se réjouit de goûter à la cuisine italienne. Nous avons pu réaliser un site Internet pour ce restaurant nouvellement créé à Aarau. Une attention particulière a été accordée à la présentation du menu. De plus, une possibilité de réservation semi-automatisée a été intégrée, ce qui soulagera l'équipe dans le quotidien du restaurant. <a href="references_coremio.php">Apprendre plus.</a></p>
        </div>
        ...
        <h2 class="references-category">Infrastructure | Support</h2>
        <div class="index-col-left">
            <a href="references_meier_2020.php">Bäckerei Confiserie Meier</a>
        </div>
        <div class="index-col-right">
            <p>La boulangerie et confiserie Meier SA à Mägenwil est une entreprise traditionnelle innovante. Au fil des années, l'infrastructure informatique a grandi avec l'entreprise et n'a cessé de s'agrandir. TEQLY a analysé le réseau existant et est arrivé à la conclusion que de nombreux clients n'étaient plus actifs et pouvaient être éliminés. <a href="references_meier_2020.php">Apprendre plus.</a></p>
        </div>
    </div>
</div>
<br>
