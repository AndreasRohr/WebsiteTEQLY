...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Zur sicheren und effizienten Lagerung von Handscannern für die Ticketkontrolle am Einlass haben wir Ladekisten für den SCB entworfen und produziert.">
...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        ...
        <div  class="title-right">
            <!--EDIT HERE-->
            <h2>Ladekisten<br>10/2021<br>Massgeschneiderte Ladelösung für Handscanner.</h2>
        </div>
