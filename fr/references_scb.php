...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        <img alt="Détail de l'image d'un plastique noir et souple." src="../assets/ref_scb.jpg">
        <div  class="title-right">
            <!--EDIT HERE-->
            <h2>Coffres de chargement<br>10/2021<br>Solution de chargement sur mesure pour les scanners portables.</h2>
        </div>
        ...
        <div class="index-col-right" style="width: 80%">
            <!--EDIT HERE-->
            <p>Nous avons conçu et produit des caisses de chargement pour le SCB afin de stocker de manière sûre et efficace les scanners manuels utilisés pour le contrôle des billets à l'entrée. Les appareils et un chargeur spécial sont placés dans une caisse UTZ Rako. À l'intérieur de la caisse, un insert en tissu à palettes fraisé au millimètre près permet de maintenir tout à sa place.</p>
        </div>
        </div>
    </div>
</div>
