...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Vous trouverez ici nos communiqués de presse et les articles nous concernant parus dans les médias..">
    ...
    <title>Nous dans la presse.</title>
...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container">
        <img alt="Image d'une pile de journaux." src="../assets/teqly_header_press.jpg">
        ...
        <div class="products-wrapper">
            <div class="products-col-right">
                <p>Nous publions ici nos communiqués de presse.</p>
            </div>
        </div>
        <div class="lineblack-index"></div>
        <div class="products-col-top">
        ...
        <div class="products-wrapper">
            <div class="products-col-right">
                <p><b>Badener Tagblatt:</b> "Les plus petits clients bénéficient d'un service informatique comme seules les grandes entreprises le font habituellement" du 28.04.2021.<br><a href="https://www.badenertagblatt.ch/aargau/brugg/brugg-die-kleinsten-kunden-erhalten-einen-it-service-wie-sonst-nur-die-grossunternehmen-ld.2130305">Lien vers l'article.</a> <a href="../assets/teqly_badenertagblatt_20210428.pdf">Télécharger l'article.</a>
            </div>
        </div>
        </div>
    </div>
