...
<div id="main" style="margin-top: 7rem">
    <div class="title-row">
        <div class="title-left">
                ...
                <!--EDIT HERE-->
                <h1  class="indextitle">Guesthouse LeLocle.</h1>
        </div>
    </div>
    <div class="index-container" style="margin-top: 4rem">
        <img alt="Image d'un petit déjeuner d'hôtel sur une tablette dans le lit." src="../assets/ref_guesthouse.jpg">
        <div  class="title-right">
            <!--EDIT HERE-->
            <h2>Extension du réseau et infrastructure des serveurs<br>06/2021<br>Extension du réseau existant, avec différents partenaires locaux. Construction d'une nouvelle salle de serveurs et d'une infrastructure informatique.</h2>
        </div>
        ...
        <div class="index-col-left" style="max-width: 20rem;white-space: normal">
            <!--EDIT HERE-->
            <h2>Guesthouse LeLocle<br>Rue Daniel Jeanrichard 27<br>2400 LeLocle<br>Neuenburg<br><a href="https://de.guesthouse-lelocle.ch/">Website</a></h2>
        </div>
        <div class="index-col-right" style="width: 80%">
            <!--EDIT HERE-->
            <p>De vastes travaux de transformation et d'extension ont été nécessaires dans la maison centenaire de LeLocle afin de pouvoir exploiter une nouvelle infrastructure réseau. La construction massive du bâtiment a posé des exigences élevées aux composants du réseau afin de pouvoir garantir une bonne couverture sans fil. Outre l'extension complète du réseau, une nouvelle salle de serveurs a été construite pour accueillir des composants supplémentaires. L'installation de télévision par satellite existante a été remplacée par une nouvelle solution de télévision par Internet. Dans le cadre de ce projet, nous avons travaillé en étroite collaboration avec les opérateurs de réseau et les entreprises artisanales locales, ce qui nous a permis de réaliser une solution globale optimale.</p>
        </div>
        </div>
    </div>
</div>
