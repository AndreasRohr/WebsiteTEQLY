...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        <img alt="Image d'un commutateur réseau avec des câbles LAN enfichés." src="../assets/ref_meier_1.jpg">
        <div  class="title-right">
            <!--EDIT HERE-->
            <h2>Nettoyer & mettre à jour<br>08/2020<br>Matériel, extension du réseau et support.</h2>
        </div>
        ...
        <div class="index-col-right" style="width: 80%">
            <!--EDIT HERE-->
            <p>La boulangerie et confiserie Meier SA à Mägenwil est une entreprise traditionnelle innovante. Au fil des années, l'infrastructure informatique a grandi avec l'entreprise et n'a cessé de s'agrandir. TEQLY a analysé le réseau existant et est arrivé à la conclusion que de nombreux clients n'étaient plus actifs et pouvaient être éliminés. En plus de la vente de quelques nouveaux composants, le réseau a été nettoyé et partiellement renouvelé en un week-end (en partie pendant l'exploitation). Les réseaux Lan et WLan existants ont également été reconfigurés afin d'être sûrs et stables pour l'avenir. Nous sommes heureux de pouvoir continuer à accompagner la boulangerie et confiserie Meier SA en tant que partenaire informatique.</p>
        </div>
        </div>
    </div>
</div>
