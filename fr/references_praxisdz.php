...
<div id="main" style="margin-top: 7rem">
    <div class="title-row">
        <div class="title-left">
                ...
                <!--EDIT HERE-->
                <h1  class="indextitle">Praxis Dolezal & Zeller.</h1>
        </div>
    </div>
    <div class="index-container" style="margin-top: 4rem">
        <img alt="Image d'une salle d'attente vide." src="../assets/ref_dolezalzeller.jpg">
        <div  class="title-right">
            <!--EDIT HERE-->
            <h2>Application<br>10/2020<br>Application, matériel et support.</h2>
        </div>
