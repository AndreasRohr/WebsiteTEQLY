...
<div id="main" style="margin-top: 7rem">
    <div class="title-row">
        <div class="title-left">
                ...
                <!--EDIT HERE-->
                <h1  class="indextitle">Kulturhof Hinter Musegg.</h1>
        </div>
    </div>
    <div class="index-container" style="margin-top: 4rem">
        <img alt="Image d'une vache dans un champ." src="../assets/ref_kulturhof.jpg">
        <div  class="title-right">
            <!--EDIT HERE-->
            <h2>Extension du réseau<br>07/2020<br></h2>
        </div>
        ...
        <div class="index-col-left" style="max-width: 20rem;white-space: normal">
            <!--EDIT HERE-->
            <h2>Kulturhof Hinter Musegg<br>Diebold-Schilling-Strasse 13<br>6004 Luzern<br>Luzern<br><a href="https://www.hinter-musegg.ch/">Website</a></h2>
        </div>
        <div class="index-col-right" style="width: 80%">
            <!--EDIT HERE-->
            <p>Afin de pouvoir mettre en place un nouveau système de caisse, le réseau existant a été développé et étendu par la pose de nouveaux câbles réseau. De nouveaux points d'accès et un W-Lan géré complètent le nouveau concept de réseau. TEQLY a été aux côtés du client de la conception à la mise en œuvre et à la mise en service réussie et a accompagné le projet dans son intégralité.</p>
        </div>
        </div>
    </div>
</div>
