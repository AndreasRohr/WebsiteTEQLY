...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="La boulangerie et confiserie Meier SA à Mägenwil est une entreprise traditionnelle innovante. Les nouvelles technologies ont rendu nécessaire l'extension du réseau interne.">
...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        <img alt="Routeur avec câbles réseau enfichés." src="../assets/ref_meier_2.jpg">
        <div  class="title-right">
            <!--EDIT HERE-->
            <h2>Expansion du réseau<br>03/2022<br>Extension du réseau avec des partenaires électriques.</h2>
        </div>
