...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        <img alt="Image d'un four en pierre en feu avec une pizza." src="../assets/ref_coremio.jpg">
        <div  class="title-right">
            <!--EDIT HERE-->
            <h2>Website<br>09/2020<br>Webdesign incluse. Outil de réservation.</h2>
        </div>
