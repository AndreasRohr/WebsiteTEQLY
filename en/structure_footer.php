        ...
        <div class="row-footer">
            ...
            <div style="margin-right: 2rem; color: black" class="col-footer">
                ...
                <div class="col-footer">
                    ...
                    <br>
                    <a style="color: black" href="https://status.teqly.app">Status page</a>
                    <br>
                    <a style="color: black" href="https://support.teqly.app">Support platform</a>
                    <br>
                    <a style="color: black" href="https://newsletter.teqly.app">Newsletter platform</a>
                </div>
            </div>
        </div>
        <div class="row-footer">
            ...
            <div style="margin-right: 2rem; color: black" class="col-footer">
                ...
                <div class="col-footer">
                    <div style="border-color: black; margin-top: 0px" class="linewhite"></div>
                    <form action="https://newsletter.teqly.app/index.php/lists/cx74898ht5437/subscribe" method="post">
                        <div class="box box-primary borderless">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group field-text wrap-fname" style="display: block">
                                    <label for="FNAME">Name</label <span class="required">*</span>> <input class="form-control field-fname field-type-text" placeholder="Firt name" type="text" value="" name="FNAME" id="FNAME" />
                                </div>
                                <div class="form-group field-text wrap-lname" style="display: block">
                                    <label for="LNAME">Nachname <span class="required">*</span></label> <input class="form-control field-lname field-type-text" placeholder="Last name" type="text" value="" name="LNAME" id="LNAME" />
                                </div>
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    <input type="submit" class="homebtnContact" name="yt0" value="Sign up" />
                                </div>
