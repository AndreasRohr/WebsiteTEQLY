...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Learn more about us and our values of transparency, agility and participation.">
...
<div id="main" style="margin-top: 7rem">
    <div class="title-row">
        <div class="title-left">
                <h1 id="titleh1" class="indextitle">About us.</h1>
        </div>
    </div>
    <div class="index-container">
        <img alt="Picture of a meeting table with computers and tablets from the top, where people are having a meeting right now." src="../assets/teqly_header_about.jpg">
        <div  class="title-right">
            <h2>It is important to us that you know who you are dealing with. Learn more about us, our philosophy and values here.</h2>
        </div>
        ...
        <div id="agility" class="under-section">
            ...
            <div class="under-section-col-right">
                <p>At TEQLY, we maintain truthful and transparent communication with all parties involved. We admit mistakes and take responsibility for our actions.</p>
            </div>
        </div>
        <div id="participation" class="under-section">
            ...
            <div class="under-section-col-right">
                <p>We focus on finding practical solutions to challenges, rather than blame. We encourage collaboration and teamwork to find innovative solutions. Continuous improvement and a willingness to learn from mistakes open up new approaches for us to identify and solve problems.</p>
            </div>
        </div>
