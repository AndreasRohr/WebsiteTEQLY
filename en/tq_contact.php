...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="We are just an email or phone call away. Contact us and we will be happy to advise you without obligation.">
...
<div id="main" style="margin-top: 4rem">
    ...
    <div class="contact-row">
        <div class="contact-left" style="margin-left: 2rem;margin-top: 3rem">
            <h2 style="margin-top: 3rem;margin-bottom: 3rem;" class="contact-subtitle">Office and warehouse:</h2>
    ...
    <div class="three-col" style="margin-bottom: 5rem;margin-left: 2rem">
        <div class="three-col-block">
            ...
            <a style="color: black; font-weight: bolder" href="../assets/vcard_jannik.vcf"
               download="vcard_jannik.vcf">Save contact data</a>
        </div>
        <div class="three-col-block">
            <h1>Andreas Rohr</h1>
            <p>Head of Support & Infrastructure</p>
            <br>
            ...
            <a style="color: black; font-weight: bolder" href="../assets/vcard_andreas.vcf"
               download="vcard_andreas.vcf">Save contact data</a>
        </div>
        <div class="three-col-block">
            <h1>Sandro Bütler</h1>
            <p>Head of Consulting & Special Projects</p>
            <br>
            ...
            <a style="color: black; font-weight: bolder" href="../assets/vcard_sandro.vcf"
               download="vcard_sandro.vcf">Save contact data</a>
        </div>
    </div>
    <div class="three-col" style="margin-bottom: 5rem; margin-left: 2rem">
        <div class="three-col-block">
            ...
            <a style="color: black; font-weight: bolder" href="../assets/vcard_bureau.vcf"
               download="vcard_bureau.vcf">Save contact data</a>
        </div>
        <div class="three-col-block">
            <h1>Support</h1>
            <br>
            ...
            <a style="color: black; font-weight: bolder" href="../assets/vcard_support.vcf"
               download="vcard_support.vcf">Save contact data</a>
        </div>
    </div>
</div>
</div>
