...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Dolezal & Zeller is a practice for psychotherapy and psychiatry in Olten. We were engaged by the practice to carry out a process optimisation in the area of patient administration.">
...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        <img alt="Picture of an empty waiting room" src="../assets/ref_dolezalzeller.jpg">
        <div  class="title-right">
            <!--EDIT HERE-->
            <h2>Application<br>10/2020<br>Application, hardware and support.</h2>
        </div>
