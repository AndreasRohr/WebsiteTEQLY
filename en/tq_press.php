...
<div id="main" style="margin-top: 7rem">
    <div class="title-row">
        <div class="title-left">
                <h1 id="titleh1" class="indextitle">Press.</h1>
        </div>
    </div>
    <div class="index-container">
        <img alt="Picture of a stack of newspapers." src="../assets/teqly_header_press.jpg">
        ...
        <div class="products-wrapper">
            <div class="products-col-right">
                <p>This is where we publish our media releases.</p>
            </div>
        </div>
        <div class="lineblack-index"></div>
        <div class="products-col-top">
        ...
        <div class="products-wrapper">
            <div class="products-col-right">
                <p><b>Badener Tagblatt:</b> "The smallest customers receive an IT service like otherwise only the large companies" of 28.04.2021.<br><a href="https://www.badenertagblatt.ch/aargau/brugg/brugg-die-kleinsten-kunden-erhalten-einen-it-service-wie-sonst-nur-die-grossunternehmen-ld.2130305">Link to the article.</a> <a href="../assets/teqly_badenertagblatt_20210428.pdf">Download article.</a>
            </div>
        </div>
        </div>
    </div>
