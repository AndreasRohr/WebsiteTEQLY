...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Bäckerei und Confiserie Meier AG in Mägenwil is an innovative company with a long tradition. Over the years, the IT infrastructure has grown with the company and has become steadily larger.">
...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        ...
        <div class="index-col-right" style="width: 80%">
            <!--EDIT HERE-->
            <p>Bäckerei und Confiserie Meier AG in Mägenwil is an innovative company with a long tradition. Over the years, the IT infrastructure has grown with the company and has steadily increased in size. TEQLY analysed the existing network and came to the conclusion that many clients were no longer active and could be cleaned out. Together with the sale of some new components, the network was cleaned out and partially renewed over a weekend (partly during ongoing operations). The existing Lan and WLan networks were also reconfigured and thus designed to be secure and stable for the future. We are pleased to be able to accompany Bäckerei und Confiserie Meier AG as an IT partner in the future as well.</p>
        </div>
        </div>
    </div>
</div>
