...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Support is the be-all and end-all of every software product. TEQLY provides 1st and 2nd level support for the customer and offers an all-round carefree package.">
...
<div id="main" style="margin-top: 7rem">
    <div class="title-row">
        <div class="title-left">
                ...
                <!--EDIT HERE-->
                <h1  class="indextitle">Eventon.</h1>
        </div>
    </div>
    <div class="index-container" style="margin-top: 4rem">
        ...
        <div class="index-col-left" style="max-width: 20rem;white-space: normal">
            <!--EDIT HERE-->
            <h2>Eventon AG<br>Rothusstrasse 23<br>6331 Hünenberg<br>Zug<br><a href="https://eventon.ch/">Website</a></h2>
        </div>
        <div class="index-col-right" style="width: 80%">
            <!--EDIT HERE-->
            <p>Support is the be-all and end-all of every software product. TEQLY provides 1st and 2nd level support for the customer and offers an all-round carefree package. Support requests are accepted by phone or email (ticket system) and processed according to the SLA. TEQLY also takes over part of the equipment management for the customer.</p>
        </div>
        </div>
    </div>
</div>
