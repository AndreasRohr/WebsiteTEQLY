...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Extensive renovation and extension work was necessary in the over 100-year-old house in LeLocle in order to be able to operate a new network infrastructure.">
...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        ...
        <div class="index-col-right" style="width: 80%">
            <!--EDIT HERE-->
            <p>Extensive renovation and extension work was necessary in the over 100-year-old house in LeLocle in order to be able to operate a new network infrastructure. The massive construction of the building placed high demands on the network components in order to guarantee good wireless coverage. In addition to the comprehensive expansion of the network, a new server room was also created in which additional components could be accommodated. The existing television installation via satellite was replaced by a new Internet TV solution. We worked closely with network operators and local craftsmen on this project and were able to realise an optimal overall solution in the end.</p>
        </div>
        </div>
    </div>
</div>
