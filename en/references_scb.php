...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="For the safe and efficient storage of hand-held scanners for ticket control at the entrance, we designed and produced loading crates for the SCB.">
...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        ...
        <div class="index-col-right" style="width: 80%">
            <!--EDIT HERE-->
            <p>For the safe and efficient storage of hand-held scanners for ticket control at the entrance, we have designed and produced charging boxes for the SCB. The devices and a special charger are stored in a UTZ Rako box. Inside the box, a shovel material inlay milled to millimetre precision ensures that everything stays in place.</p>
        </div>
        </div>
    </div>
</div>
