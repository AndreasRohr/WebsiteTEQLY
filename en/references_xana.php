...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Xana was looking for a hardware partner to flexibly rent hardware and found TEQLY.">
...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        ...
        <div class="index-col-right" style="width: 80%">
            <!--EDIT HERE-->
            <p>Xana was looking for a hardware partner to flexibly rent hardware and found TEQLY. TEQLY equipped the mobile health centres with phones, tablets, laptops and routers. A particular challenge in this project was the requirement that all devices must have a direct internet connection via mobile network. Together with our hardware partners, we were able to implement this request and configure special laptops with a 4G module.</p>
        </div>
        </div>
    </div>
</div>
