...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Bäckerei und Confiserie Meier AG in Mägenwil is an innovative traditional company. New technologies made it necessary to expand the internal network.">
...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        ...
        <div class="index-col-right" style="width: 80%">
            <!--EDIT HERE-->
            <p>Bäckerei und Confiserie Meier AG in Mägenwil is an innovative traditional company. New technologies made it necessary to expand the internal network. In cooperation with a local electrical company, the existing network infrastructure was expanded to cover additional areas. TEQLY accompanied all phases, from consulting to installation and commissioning. We would like to thank Bäckerei Meier for their trust and look forward to realising further projects together in the future!</p>
        </div>
        </div>
    </div>
</div>
