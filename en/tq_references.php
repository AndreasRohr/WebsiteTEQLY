...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Let yourself be inspired by this selection of projects that we have already had the pleasure of realising.">
...
<div id="main" style="margin-top: 7rem">
    <div class="title-row">
        <div class="title-left">
                <h1 class="indextitle">Our projects.</h1>
        </div>
    </div>
    <div class="index-container" style="margin-top: 4rem">
        <div  class="title-right">
            <h2>Let yourself be inspired.<br><br>Here you will find a selection of projects that we have had the pleasure of implementing together with our clients in the past.</h2>
        </div>
