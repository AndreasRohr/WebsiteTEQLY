...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="We are always looking for personalities to complement and expand our team.">
    ...
    <title>Open positions with us.</title>
...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        <div  class="title-right">
            <!--EDIT HERE-->
            <h2>We have grown strongly in the past year and would like to continue to do so.<br>We need you for that!</h2>
        </div>
        ...
        <div class="header-row"style="grid-template-columns: repeat(2,auto); margin-top: 5rem;">
            ...
            <div class="index-col-right" style="width: 80%; margin-bottom: 2rem">
                <!--EDIT HERE-->
                <ul>
                    <li>Create requirements documents.</li>
                    <li>Planning development projects, including release and milestone planning.</li>
                    <li>Developing websites and applications.</li>
                    <li>Creating documentation.</li>
                    <li>Ensuring code quality by means of tests.</li>
                </ul>
            </div>
            <div class="index-col-left" style="max-width: 20rem;white-space: normal">
                <!--EDIT HERE-->
            ...
            <div class="index-col-right" style="width: 80%; margin-bottom: 2rem">
                <!--EDIT HERE-->
                <ul>
                    <li>You are studying computer science or a comparable technical degree programme.</li>
                    <li>You are an open and curious personality.</li>
                    <li>You would like to gain professional experience and develop software in a small workload.</li>
                    <li>You have already gained experience in developing software and are fit in the languages Javascript, HTML, CSS, JAVA, PHP.</li>
                    <li>You are willing to familiarise yourself with different languages and frameworks.</li>
                </ul>
            </div>
            <div class="index-col-left" style="max-width: 20rem;white-space: normal">
                <!--EDIT HERE-->
        ...
        <div  class="title-right">
            <!--EDIT HERE-->
            <h2>Nothing suitable?</h2>
        </div>
        <p style="margin-top: 3rem; margin-bottom: 5rem">And if there is no suitable vacancy advertised at the moment, just get in touch with us. We also look forward to receiving a speculative application from you, in which you show us why you can bring TEQLY forward.</p>
        <button style="margin-bottom: 3rem" class="homebtnContact" onclick="location.href='mailto:work@teqly.ch';">Send spontaneous application now</button>
    </div>
</div>
<br>
