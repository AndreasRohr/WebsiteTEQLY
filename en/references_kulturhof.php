...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="In order to be able to implement a new cash register system, the existing network was expanded and extended by laying new network cables.">
...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        ...
        <div class="index-col-right" style="width: 80%">
            <!--EDIT HERE-->
            <p>In order to be able to implement a new cash register system, the existing network was expanded and extended by laying new network cables. New access points and a managed WLAN complete the new network concept. TEQLY was at the customer's side from the conception, through the implementation, to the successful commissioning and fully supported the project.</p>
        </div>
        </div>
    </div>
</div>
