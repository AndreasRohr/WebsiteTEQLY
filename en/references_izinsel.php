...
<div id="main" style="margin-top: 7rem">
    ...
    <div class="index-container" style="margin-top: 4rem">
        ...
        <div class="index-col-right" style="width: 80%">
            <!--EDIT HERE-->
            <p>TEQLY installed extensive monitoring and network technology, including the associated software, for the newly built "Insel Vaccination Centre" at the Inselspital Bern. The core of the system is an automated fever measurement. Using the latest technology, it is thus possible to automatically measure the body temperature of all persons (up to 5 people at a time) in passing. If an elevated temperature is measured in a person, a visual and acoustic alarm is triggered. In this way, it can be ensured that no person with a fever is in the centre, even in the event of a large crowd. The data from the camera is not stored and cannot be traced back, so the system is also data protection compliant.</p>
        </div>
        </div>
    </div>
</div>
